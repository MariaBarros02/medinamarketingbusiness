...
const Guests = () => {
  return (
    <>
        ...
        <div className="w-10/12 m-auto  md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-x-5 md:gap-y-5">
          ...
          >
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400 text-sm">
              Medina Marketing offers a wide range of properties, from cozy apartments to spacious houses, catering to diverse preferences and group sizes. Whether you’re traveling solo, with family, or friends, you’ll find the perfect accommodation to suit your needs.
            </p>
          </Card>
          <Card
            className="max-w-sm mx-auto"
            imgAlt="Meaningful alt text for an image that is not purely decorative"
            imgSrc="/images/image_15.jpg"
          >
            <h5 className="text-xl font-bold tracking-tight text-yellow-600 dark:text-white">
              Prime Locations
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400 text-sm">
              Our properties are strategically located in prime areas, ensuring you have easy access to major attractions, public transportation, and essential services. Enjoy the convenience of staying in the heart of your chosen destination.
            </p>
          </Card>
          <Card
            className="max-w-sm mx-auto"
            imgAlt="Meaningful alt text for an image that is not purely decorative"
            imgSrc="/images/image_12.jpg"
          >
            <h5 className="text-xl font-bold tracking-tight text-yellow-600 dark:text-white">
              High-Quality Standards
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400 text-sm">
              We maintain strict quality standards for all our properties, ensuring they are clean, well-maintained, and equipped with modern amenities. Your comfort and satisfaction are our top priorities, so you can relax and enjoy your stay.
            </p>
          </Card>
          <Card
            className="max-w-sm mx-auto"
            imgAlt="Meaningful alt text for an image that is not purely decorative"
            imgSrc="/images/image_13.jpg"
          >
            <h5 className="text-xl font-bold tracking-tight text-yellow-600 dark:text-white">
              Excellent Customer Service
            </h5>
            <p className="font-normal text-gray-700 dark:text-gray-400 text-sm">
              Medina Marketing is committed to providing exceptional customer service. Our dedicated support team is available to assist you with any questions or concerns before, during, and after your stay, ensuring a seamless and enjoyable experience.
            </p>
          </Card>
        </div>
      ...
      <section className="bannerContacto p-5 h-auto md:grid md:grid-cols-2 md:gap-x-3">
      ...
      <section className="">
        <div className="w-10/12 m-auto py-20">
          <h2 className="text-2xl text-cyan-950">Recent Reviews <span className="text-sm">On Airbnb</span></h2>
          <div className="lg:grid lg:grid-cols-2 lg:gap-x-5" >
            ...
            <Critica
              ...
              titulo="Luxury House, Enjoy It to the Fullest"
